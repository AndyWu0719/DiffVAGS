#!/bin/bash
#SBATCH --job-name=diffvags_stage1_standard          # create a short name for your job
...
srun python /home/dwubf/workplace/DiffVAGS/train.py \
    --exp_dir /home/dwubf/workplace/DiffVAGS/experiments/stage1_modulation \
    --batch_size 4 \
    --workers 8
